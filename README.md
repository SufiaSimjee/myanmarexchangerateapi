...
Disclaimer:
    ...
    2. The developer does not take any responsibility for any discrepancies or losses resulting from the use of data provided by api.
...
1. Prerequisites
    ...
    - MongoDB Atlas Account (First, create a database on MongoDB Atlas and obtain connection string).

2. Set Environment Variables
   - Create a .env file in the project root with the following variables:
        i. PORT = your chosen port number
        ii. MONGODBURL = MongoDB Atlas connection string (e.g., mongodb+srv://<username>:<password>@cluster0.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0)
        iii. HOST = 0.0.0.0
        iv. JWT_SECRET = your_jwt_secret
...
4. Run the Project
   - npm start (The server will start on the port specified in your .env file).
